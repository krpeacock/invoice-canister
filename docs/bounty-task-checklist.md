...
- [x] **Adding the required ICRC1 token-ledger canister typings:**  
    ✶ [src/invoice/modules/supported-token/token-specific/icrc1/Types.mo](https://github.com/krpeacock/invoice-canister/tree/main/src/invoice/modules/supported-token/token-specific/icrc1/Types.mo)  

- [x] **For consistency and integration adding an ICRC1 token-ledger canister actor supertype:**  
    ✶ [src/invoice/modules/supported-token/token-specific/icrc1/ActorSupertype.mo](https://github.com/krpeacock/invoice-canister/tree/main/src/invoice/modules/supported-token/token-specific/icrc1/ActorSupertype.mo)  

- [x] **Adding the logic for ICRC1 addressing computations:**  
  - [x] [src/invoice/modules/supported-token/token-specific/icrc1/Adapter.mo](https://github.com/krpeacock/invoice-canister/tree/main/src/invoice/modules/supported-token/token-specific/icrc1/Adapter.mo)  
     - [x] `isValidSubaccount()`  
     - [x] `isValidAddress()`  
     - [x] `encodeAddress()`  
     - [x] `decodeAddress()`  
...
- [x] **Adding the logic connecting those addressing transformations to the invoice canister's API methods:**
  - [x] [src/invoice/modules/supported-token/SupportedToken.mo](https://github.com/krpeacock/invoice-canister/tree/main/src/invoice/modules/supported-token/SupportedToken.mo).  
  ...
  - [x] **Implementing the actual use of the above methods in the invoice canister's API methods in [src/invoice/Invoice.mo](https://github.com/krpeacock/invoice-canister/tree/main/src/invoice/Invoice.mo):**  
    - [x] `create_invoice()`  
